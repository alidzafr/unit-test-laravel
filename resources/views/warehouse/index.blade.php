<x-layout title="Gudang">
    <div class="space-y-6">
        ...
        <div class="flex justify-between space-x-4">
            ...
            @role('owner')
                <a href="{{ route('warehouse.create') }}" class="btn btn-primary rounded-xl">
                    + Tambah Pelanggan
                </a>
            @endrole
                ...
                <tr class="group hover:bg-gray-100 transition-colors">
                    ...
                    <td>
                        <div class="min-w-0 flex-auto">
                            <p class="text-sm/6 font-semibold text-gray-900">{{ $warehouse->name }}</p>
                        </div>
                    </td>
                    ...
                    <td>
                        <div class="flex justify-center space-x-2">
                            <a href="{{ route('warehouse.show', $warehouse->slug) }}" class="btn btn-soft btn-info rounded-xl opacity-0 group-hover:opacity-100 transition-opacity">
                                View
                            </a>
                            <a href="{{ route('warehouse.edit', $warehouse->slug) }}" class="btn btn-soft btn-warning rounded-xl opacity-0 group-hover:opacity-100 transition-opacity">
                                Edit
                            </a>
                        </div>
                    </td>
