<x-layout title="Kategori Detail">
    
    <div class="space-y-6">
        {{-- Category edit button--}}
        <div class="flex justify-between">
            <a href="{{ route('categories.index') }}" class="btn btn-soft btn-primary rounded-xl">
                Kembali
            </a>
            <a href="{{ route('categories.edit', $category->slug) }}" class="btn btn-soft btn-secondary rounded-xl">
                Edit
            </a>
        </div>
